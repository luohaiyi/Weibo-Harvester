...
class SearchSpider(scrapy.Spider):
    name = 'search'
    allowed_domains = ['weibo.com', 'sinaimg.cn', 'weibocdn.com']
    ...
    start_date = settings.get('START_DATE') or datetime.now().strftime('%Y-%m-%d')
    end_date = settings.get('END_DATE') or datetime.now().strftime('%Y-%m-%d')
